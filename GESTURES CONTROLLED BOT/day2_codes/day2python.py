...
# with mp_hands.Hands(min_detection_confidence=0.7, min_tracking_confidence=0.5, max_num_hands=2, static_image_mode=False) as hands:
#     while cam.isOpened():
