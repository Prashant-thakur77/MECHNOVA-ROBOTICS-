...
const int dutyCycle1 = 300;   // Speed duty cycle for forward/backward
const int dutyCycle2 = 300;   // Speed duty cycle for turning

//
// WiFi credentials
//Enter according to your device

const char* ssid = "PRASHANT 7206";
const char* password = "7,50U7z7";
